...
<div class="card shadow mb-4">
    <div class="card-header bg-primary">
        <div class="row">
            <div class="textT col-sm-6 text-left d-flex align-items-center font-weight-bold text-white">CLIENTES</div>
            <div class="col-sm-6 text-right">
                <button class="btn btn-danger" type="button" onclick="frmCliente()">Agregar <i class="m-1 fa-solid fa-circle-plus"></i></button>
            </div>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="display responsive nowrap table" style="width: 100%;" id="tblClientes">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h5 class="modal-title text-white font-weight-bold" id="title">Agregar Cliente</h5>
                        <button class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form id="frmCliente" action="" method="post">
                            <div class="form-group">
                                <label for="cedula" class="font-weight-bold">Cédula/RUC</label>
                                <input type="hidden" name="id" id="id">
                                <input id="cedula" class="form-control" type="text" name="cedula" placeholder="Cédula de identidad o RUC del cliente" require>
                            ...
                            <div class="form-group">
                                ...
                                <input id="nombre" class="form-control" type="text" name="nombre" placeholder="Nombre del Cliente" require>
                            ...
                            <div class="form-group">
                                ...
                                <input id="correo" class="form-control" type="text" name="correo" placeholder="Correo electrónico del cliente">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="direccion" class="form-control" name="direccion" rows="3" placeholder="Dirección del cliente" require></textarea>
